...
#'
#' [2] Micheletti, M. I. and R. D. Piacentini (2002) Irradiancia espetral solar UV-B y su relación
#' con la efectividad de daño biológico a las plantas. ANALES AFA, 13, 242-248
#'
...
#' wavelength boundary is not specified, but 313.3 nm is usually used. The equation
#' is coded here with the limit at 342 nm as at longer wavelengths the values increase
#' with increasing wavelength.
#' The effect on the RAF and doses of changing this boundary ican be substantial, and
