...
#'
#' @usage GEN.M(norm=300, w.low=275, w.high=313.3)
#'
...
GEN.M <- function(norm=300, w.low=275, w.high=313.3) {
  new_waveband(w.low=w.low, w.high=w.high, weight="SWF", SWF.q.fun=GEN.M.q.fun, SWF.norm=300,
