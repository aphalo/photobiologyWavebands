...
#' 
#' @usage UVI_wb(std = "NOAA")
#' @param std "NOAA" or "WMO"
#' @return a list defining the wavelength range, weighting and normalization. This is just
...
#' lower limit at 250 nm. "NOAA" is the default as this is safer with noisy data
#' for sunlight, and for solar radiation the value of UVI should be correct. When
#' calculating UVI for radiation spectra from UV lamps, "WMO" should be used.
#' 
#' @references
...
#' 
#' @export
#' @seealso \code{\link{UVI}}, \code{\link{CIE}}, \code{\link{photon_irradiance}} and \code{\link{energy_irradiance}}
#' @examples
#' UVI_wb()
