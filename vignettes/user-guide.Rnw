...
%\VignetteDepends{knitr, photobiology, photobiologyWbands}
...
\newcommand{\PBWB}{\textsf{photobiologyWbands}\xspace}
...
library(photobiologyWbands)
@

<<own-set-up, echo=FALSE, include=FALSE>>=
my_version <- packageVersion("photobiologyWbands")
@
