...
library(knitr)
opts_chunk$set(fig.path='figure/pos-', fig.align='center', fig.show='hold', size="footnotesize",            fig.width=8, fig.height=6, out.width='.95\\textwidth')
...
\textsf{%
       ...
       Gen. plant action & Thimijan & \texttt{GEN.T(norm, w.low, w.high)} & 300 & 275 & 313.3\\
...
<<>>=
plot(sun.spct * CIE(), annotations = NULL)
@

<<>>=
plot(source.spct(285:400, 1) * CIE(), annotations = NULL)
@
